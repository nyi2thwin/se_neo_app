(function () {
    ...
    viewAppointmentHistoryController.$inject = ['$scope', '$http', '$filter', '$location','$rootScope'];
    function viewAppointmentHistoryController($scope, $http, $filter, $location,$rootScope) {
		 var vm = this;
